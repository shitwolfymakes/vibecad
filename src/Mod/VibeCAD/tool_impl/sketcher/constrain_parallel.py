...
"""Typed native Sketcher parallel constraint tool."""
...
TOOL_SPEC = {
    "name": "sketcher.constrain_parallel",
    "description": "Add a native Sketcher Parallel constraint between two geometry elements.",
    "contextual": True,
    "parameters": {
        "type": "object",
        "properties": {
