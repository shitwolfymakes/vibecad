...
"""Typed native Sketcher vertical distance constraint tool."""
...
TOOL_SPEC = {
    "name": "sketcher.constrain_distance_y",
    "description": "Add a native Sketcher DistanceY dimension between two point roles or from one point role to the sketch X axis.",
    "contextual": True,
    "parameters": {
        "type": "object",
        "properties": {
