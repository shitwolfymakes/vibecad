...
"""Typed native Sketcher radius constraint tool."""
...
TOOL_SPEC = {
    "name": "sketcher.constrain_radius",
    "description": "Add a native Sketcher Radius dimension to one circular or arc geometry element with an explicit millimeter value.",
    "contextual": True,
    "parameters": {
        "type": "object",
        "properties": {
