...
"""Typed native Sketcher tangent constraint tool."""
...
TOOL_SPEC = {
    "name": "sketcher.constrain_tangent",
    "description": "Add a native Sketcher Tangent constraint between two geometry elements.",
    "contextual": True,
    "parameters": {
        "type": "object",
        "properties": {
